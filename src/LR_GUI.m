...
% feature selection method textbox
h.t(22)  = uicontrol('style','text','units','normalized','pos',[x2+0.005,0.29,x3-(x2+0.005),0.025],'string','Feature selection method','fontweight','b','HorizontalAlignment','left');
    ...
    function p0_call(varargin)
        if ~checkThings
            ...
            if (fileName(1) == 0) && (path2File(1) == 0)
                ...
                set([h.cb_plots(:);h.rb_samedistribution(:);h.rb_diffdistribution(:)],'fontweight','n','backgroundcolor','default');
                cla(h.ax1)
                set(h.t(10),'userData',[]);
...
h.p11 = uicontrol('style','pushbutton','units','normalized','pos',...
    [x2+0.005,0.21,(x3-(x2+0.005)),0.03],'string','Execute',...
    ...
    function p11_call(varargin)
        if(strcmp(get(h.t(3),'string'),'distances computed'))
            checked = get(h.dropdown_feature_selection, 'value');
            set([h.p0,h.p1,h.p2,h.p3,h.p4,h.p5,h.p6,h.p7,h.p8,h.p9,h.p10,h.p12,h.p13,h.p14,h.p15,h.p16,h.p18,h.cb_features,h.cb_labels,h.rb_samedistribution,h.rb_diffdistribution,h.cb_plots,h.popup1,h.popup2,h.dropdown_feature_selection],'enable','off');
            ...
            set([h.p0,h.p1,h.p2,h.p3,h.p4,h.p5,h.p6,h.p7,h.p8,h.p9,h.p10,h.p12,h.p13,h.p14,h.p15,h.p16,h.cb_features,h.cb_labels,h.cb_plots,h.popup1,h.popup2,h.dropdown_feature_selection],'enable','on');
        end
    end
...
e2_tt = 'Manually set a kernel bandwidth for the kernel density estimation, larger bandwidth vlaues will lead to smoother density estimates'; 
h.e2 = uicontrol('style','edit','TooltipString', e2_tt,'units','normalized',...
...
h.e3 = uicontrol('style','edit','TooltipString', e2_tt,'units','normalized',...
...
p18_tt = 'Load a CSV containing a set of precalculated scores from pairwise comparison of same-source and different-source labels';
h.p18 = uicontrol('style','pushbutton','TooltipString', p18_tt,'units','normalized','pos',[x1+0.065,0.97,0.06,0.025],'string','Load Scores',...
    ...
    function p18_call(varargin)
        if ~checkThings
            ...
            if (fileName(1) == 0) && (path2File(1) == 0)
                ...
                set([h.p1,h.p2,h.p3,h.p6,h.p7,h.p8,h.p9,h.p10,h.p11,h.p13,h.p15,...
                h.popup1,h.popup2,h.e1,h.cb_data_overview(1:3),h.dropdown_feature_selection],'enable','off')
